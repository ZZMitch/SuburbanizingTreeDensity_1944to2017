...
drivers <- read.csv("UTM_drivers.csv")
treecounts <- read.csv("UTM_treecount.csv")
treechanges <- read.csv("UTM_treechange.csv")
...
write.csv(lcdata4417, file = "Rur_LC4417.csv")
...
dr_treechange_hum <- rbind(dr_building, dr_road, dr_minor, dr_excav, dr_water, dr_building_rm, dr_road_rm, 
                           dr_tennis, dr_baseball)
dr_treechange_nat <- rbind(dr_forest_exp, dr_tree_gr, dr_tree_ad, dr_tree_rm, dr_plant_nat, dr_urban_gr, dr_veg_gr)

write.csv(dr_treechange_hum, "UTM_dr_tc_hum.csv")
write.csv(dr_treechange_nat, "UTM_dr_tc_nat.csv")

### Manual Fixes ###
dr_treechange_hum$TreeChange[522:526] = 0
...
axis(1, labels = c("Building\nConstruction", "Excavation", "Infrastructure\nRemoval", "Minor\nConstruction", 
                   "Road\nConstruction", "Sport\nConstruction", "Waterbody\nConstruction"), at = 1:7, tick = FALSE)
...
### Calculate Means ###
mean(dr_treechange_hum$TreeChange)
...
mean(dr_treechange_nat$TreeChange)
...
### Calculate SD ###
sd(dr_treechange_hum$TreeChange)
sd(dr_treechange_hum[dr_treechange_hum$Driver == "Building construction","TreeChange"])
sd(dr_treechange_hum[dr_treechange_hum$Driver == "Road construction","TreeChange"])
sd(dr_treechange_hum[dr_treechange_hum$Driver == "Minor construction","TreeChange"])
sd(dr_treechange_hum[dr_treechange_hum$Driver == "Excavation","TreeChange"])
sd(dr_treechange_hum[dr_treechange_hum$Driver == "Waterbody construction","TreeChange"])
sd(dr_treechange_hum[dr_treechange_hum$Driver == "Infrastructure removal","TreeChange"])
sd(dr_treechange_hum[dr_treechange_hum$Driver == "Sport construction","TreeChange"])

sd(dr_treechange_nat$TreeChange)
sd(dr_treechange_nat[dr_treechange_nat$Driver == "Forest expansion","TreeChange"])
sd(dr_treechange_nat[dr_treechange_nat$Driver == "Tree growth","TreeChange"])
sd(dr_treechange_nat[dr_treechange_nat$Driver == "Trees added","TreeChange"])
sd(dr_treechange_nat[dr_treechange_nat$Driver == "Tree removal","TreeChange"])
sd(dr_treechange_nat[dr_treechange_nat$Driver == "Plantation naturalized","TreeChange"])
sd(dr_treechange_nat[dr_treechange_nat$Driver == "Other greening","TreeChange"])

...
drivers <- read.csv("Driver Influence/N2_drivers.csv")
treecounts <- read.csv("Tree Time Series/Tree Counts/N2_treecount.csv")
treechanges <- read.csv("Tree Time Series/Tree Change/N2_treechange.csv")
...
write.csv(lcdata4417, file = "N2_LC4417.csv")
...
# Fill in Driver Column #
dr_excav$Driver <- "Road construction"
...
# Fill in Driver Column #
dr_urban_gr$Driver <- "Trees added"
...
write.csv(dr_treechange_hum, "N2_dr_tc_hum.csv")
write.csv(dr_treechange_nat, "N2_dr_tc_nat.csv")
...
axis(1, labels = c("Building\nConstruction", "Land\nClearing", 
                   ...
                   "Sport\nConstruction", "Waterbody\nConstruction"), at = 1:7, tick = FALSE, cex.axis = 1)

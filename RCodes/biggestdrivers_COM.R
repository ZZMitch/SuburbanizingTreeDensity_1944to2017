...
setwd("C:/Users/mitch/Google Drive/PHD/Thesis Research/Mississauga Tree Changes 1944-2017")

drivers <- read.csv("Driver Influence/I2_drivers2.csv")
...
write.csv(biggestdrivers, "bigdrivers_I2_2.csv")
#write.csv(biggestdrivers, "bigdrivers5_I2.csv")

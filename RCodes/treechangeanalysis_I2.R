...
drivers <- read.csv("Driver Influence/I2_drivers.csv")
treecounts <- read.csv("Tree Time Series/Tree Counts/I2_treecount.csv")
treechanges <- read.csv("Tree Time Series/Tree Change/I2_treechange.csv")
...
write.csv(lcdata4417, file = "I2_LC4417.csv")
...
# Manual check (10+) #
dr_forest_exp$TreeChange[2:3] = 10
dr_forest_exp$TreeChange[5:6] = 7
dr_forest_exp$TreeChange[10] = 1
...
# Manual check (10+) #
dr_tree_gr$TreeChange[33:34] = 7
dr_tree_gr$TreeChange[42] = 8
...
#### Merge Driver Tables ####
dr_treechange_hum <- rbind(dr_building, dr_road, dr_minor, dr_water, dr_building_rm, dr_road_rm, 
                           dr_tennis, dr_baseball, dr_golf, dr_farming, dr_plant_har) #dr_excav
dr_treechange_nat <- rbind(dr_forest_exp, dr_tree_gr, dr_tree_ad, dr_tree_rm, dr_plant_nat, dr_plant_gr,
                           dr_urban_gr, dr_river) #dr_veg_gr

write.csv(dr_treechange_hum, "I2_dr_tc_hum.csv")
write.csv(dr_treechange_nat, "I2_dr_tc_nat.csv")
...
axis(1, labels = c("Forest\nExpansion",
                   "Tree\nRegeneration", "Tree\nRemoval", 
                   "Trees\nPlanted"), at = 1:4, tick = FALSE, cex.axis = 1)
